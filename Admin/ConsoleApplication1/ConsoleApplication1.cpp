...
// -----------------doctor class and Receptionist for test  --------------------
...
public:
    ...
    Doctor() {}
    Doctor(int id, string name, int age, string phone, string spec)
        : id(id), name(name), age(age), phone(phone), specialty(spec) {
    }
};
...
public:
    ...
    Receptionist() {}
    Receptionist(int id, string name, int age, string phone, string user)
        : id(id), name(name), age(age), phone(phone), username(user) {
    }
};
...
int main() {
    ...
    cout << "Testing Admin System...\n";
    cout << "Press any key to open menu...\n";
    _getch();
